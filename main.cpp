...
{
	if (RoundInfo.Playere1Choise == RoundInfo.ComputerChoice)
	{
		return enWinner::Draw;
	}

	switch (RoundInfo.Playere1Choise)
	{
...
void PrintRoundResults(stRoundInfo RoundInfo)
{
	...
	cout << "Player1  Choice: " << ChoiceName(RoundInfo.Playere1Choise) << endl;
...
stGameResults PlayGame(short HowManyRounds)
{
	...
	for (short GameRound = 1; GameRound <= HowManyRounds; GameRound++)
	{
		...
		RoundInfo.Playere1Choise = ReadPlayer1Choice();
...
void ShowFinalGameResults(stGameResults GameResults)
{
	...
	cout << Tabs(2) << "Final Wineer       : " << GameResults.WinnerName << endl;
	cout << Tabs(2) << "__________________________________________________________\n";
